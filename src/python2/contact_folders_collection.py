...
from ..request import contact_folder_request_builder # import ContactFolderRequestBuilder
#from .contact_folder_request_builder import ContactFolderRequestBuilder
...
class ContactFoldersCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`ContactFoldersCollectionPage<microsoft.msgraph.request.contact_folders_collection.ContactFoldersCollectionPage>`:
...
class ContactFoldersCollectionRequestBuilder(RequestBuilderBase):
    ...
    def __getitem__(self, key):
        ...
        Returns: 
            :class:`ContactFolderRequestBuilder<microsoft.msgraph.request.contact_folder_request_builder.ContactFolderRequestBuilder>`:
    ...
    def request(self, expand=None, select=None, top=None, order_by=None, options=None):
        ...
        Returns:
            :class:`ContactFoldersCollectionRequest<microsoft.msgraph.request.contact_folders_collection.ContactFoldersCollectionRequest>`:
