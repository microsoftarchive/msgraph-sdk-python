...
class EventTentativelyAcceptRequest(RequestBase):

    def __init__(self, request_url, client, options, comment=None, send_response=None):
        super(EventTentativelyAcceptRequest, self).__init__(request_url, client, options)
        self.method = "POST"
        self.body_options={}
...
class EventTentativelyAcceptRequestBuilder(RequestBuilderBase):

    def __init__(self, request_url, client, comment=None, send_response=None):
        super(EventTentativelyAcceptRequestBuilder, self).__init__(request_url, client)
    ...
    def request(self, options=None):
        """Builds the request for the EventTentativelyAccept
        ...
        Returns: 
            :class:`EventTentativelyAcceptRequest<microsoft.msgraph.request.event_tentatively_accept.EventTentativelyAcceptRequest>`:
                The request
        """
        req = EventTentativelyAcceptRequest(self._request_url, self._client, options, comment=self._method_options["Comment"], send_response=self._method_options["SendResponse"])
        return req
