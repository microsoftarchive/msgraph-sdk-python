...
class DriveItemCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`DriveItemCollectionPage<microsoft.msgraph.request.drive_item_collection.DriveItemCollectionPage>`:
...
class DriveItemCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self, expand=None, select=None, top=None, order_by=None, options=None):
        ...
        Returns:
            :class:`DriveItemCollectionRequest<microsoft.msgraph.request.drive_item_collection.DriveItemCollectionRequest>`:
