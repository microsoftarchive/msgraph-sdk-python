...
class ItemsCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`ItemsCollectionPage<microsoft.msgraph.request.items_collection.ItemsCollectionPage>`:
...
class ItemsCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self, expand=None, select=None, top=None, order_by=None, options=None):
        ...
        Returns:
            :class:`ItemsCollectionRequest<microsoft.msgraph.request.items_collection.ItemsCollectionRequest>`:
