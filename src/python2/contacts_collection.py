...
class ContactsCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`ContactsCollectionPage<microsoft.msgraph.request.contacts_collection.ContactsCollectionPage>`:
...
class ContactsCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self, expand=None, select=None, top=None, order_by=None, options=None):
        ...
        Returns:
            :class:`ContactsCollectionRequest<microsoft.msgraph.request.contacts_collection.ContactsCollectionRequest>`:
