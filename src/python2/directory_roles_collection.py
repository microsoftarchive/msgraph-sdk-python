...
class DirectoryRolesCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`DirectoryRolesCollectionPage<microsoft.msgraph.request.directory_roles_collection.DirectoryRolesCollectionPage>`:
...
class DirectoryRolesCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self, expand=None, select=None, top=None, order_by=None, options=None):
        ...
        Returns:
            :class:`DirectoryRolesCollectionRequest<microsoft.msgraph.request.directory_roles_collection.DirectoryRolesCollectionRequest>`:
