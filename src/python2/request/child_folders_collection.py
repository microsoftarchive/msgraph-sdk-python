...
class ChildFoldersCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`ChildFoldersCollectionPage<microsoft.msgraph.request.child_folders_collection.ChildFoldersCollectionPage>`:
...
class ChildFoldersCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self, expand=None, select=None, top=None, order_by=None, options=None):
        ...
        Returns:
            :class:`ChildFoldersCollectionRequest<microsoft.msgraph.request.child_folders_collection.ChildFoldersCollectionRequest>`:
