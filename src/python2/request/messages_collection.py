...
class MessagesCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`MessagesCollectionPage<microsoft.msgraph.request.messages_collection.MessagesCollectionPage>`:
...
class MessagesCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self, expand=None, select=None, top=None, order_by=None, options=None):
        ...
        Returns:
            :class:`MessagesCollectionRequest<microsoft.msgraph.request.messages_collection.MessagesCollectionRequest>`:
