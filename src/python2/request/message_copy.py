...
class MessageCopyRequest(RequestBase):

    def __init__(self, request_url, client, options, destination_id=None):
        super(MessageCopyRequest, self).__init__(request_url, client, options)
        self.method = "POST"
        self.body_options={}
...
class MessageCopyRequestBuilder(RequestBuilderBase):

    def __init__(self, request_url, client, destination_id=None):
        super(MessageCopyRequestBuilder, self).__init__(request_url, client)
        self._method_options = {}

        self._method_options["DestinationId"] = destination_id

    def request(self, options=None):
        """Builds the request for the MessageCopy
        ...
        Returns: 
            :class:`MessageCopyRequest<microsoft.msgraph.request.message_copy.MessageCopyRequest>`:
                The request
        """
        req = MessageCopyRequest(self._request_url, self._client, options, destination_id=self._method_options["DestinationId"])
        return req
