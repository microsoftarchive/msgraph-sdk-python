...
class EventCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`EventCollectionPage<microsoft.msgraph.request.event_collection.EventCollectionPage>`:
...
class EventCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self, expand=None, select=None, top=None, order_by=None, options=None):
        ...
        Returns:
            :class:`EventCollectionRequest<microsoft.msgraph.request.event_collection.EventCollectionRequest>`:
