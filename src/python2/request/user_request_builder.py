...
class UserRequestBuilder(RequestBuilderBase):
    ...
    def request(self, expand=None, select=None, options=None):
        ...
        Returns:
            :class:`UserRequest<microsoft.msgraph.request.user_request.UserRequest>`:
                The UserRequest
        """
    ...
    def owned_devices(self):
        ...
        Returns: 
            :class:`DirectoryObjectCollectionRequestBuilder<microsoft.msgraph.request.owned_devices_collection.DirectoryObjectCollectionRequestBuilder>`:
    ...
    def registered_devices(self):
        ...
        Returns: 
            :class:`DirectoryObjectCollectionRequestBuilder<microsoft.msgraph.request.registered_devices_collection.DirectoryObjectCollectionRequestBuilder>`:
                A request builder created from the UserRequestBuilder
        """
    ...
    def direct_reports(self):
        ...
        Returns: 
            :class:`DirectoryObjectCollectionRequestBuilder<microsoft.msgraph.request.direct_reports_collection.DirectoryObjectCollectionRequestBuilder>`:
                A request builder created from the UserRequestBuilder
        """
    ...
    def member_of(self):
        ...
        Returns: 
            :class:`DirectoryObjectCollectionRequestBuilder<microsoft.msgraph.request.member_of_collection.DirectoryObjectCollectionRequestBuilder>`:
                A request builder created from the UserRequestBuilder
        """
    ...
    def created_objects(self):
        ...
        Returns: 
            :class:`DirectoryObjectCollectionRequestBuilder<microsoft.msgraph.request.created_objects_collection.DirectoryObjectCollectionRequestBuilder>`:
                A request builder created from the UserRequestBuilder
        """
    ...
    def owned_objects(self):
        ...
        Returns: 
            :class:`DirectoryObjectCollectionRequestBuilder<microsoft.msgraph.request.owned_objects_collection.DirectoryObjectCollectionRequestBuilder>`:
                A request builder created from the UserRequestBuilder
        """
    ...
    def mail_folders(self):
        ...
        Returns: 
            :class:`MailFolderCollectionRequestBuilder<microsoft.msgraph.request.mail_folders_collection.MailFolderCollectionRequestBuilder>`:
                A request builder created from the UserRequestBuilder
        """
    ...
    def calendar_groups(self):
        ...
        Returns: 
            :class:`CalendarGroupCollectionRequestBuilder<microsoft.msgraph.request.calendar_groups_collection.CalendarGroupCollectionRequestBuilder>`:
                A request builder created from the UserRequestBuilder
        """
    ...
    def contact_folders(self):
        ...
        Returns: 
            :class:`ContactFolderCollectionRequestBuilder<microsoft.msgraph.request.contact_folders_collection.ContactFolderCollectionRequestBuilder>`:
                A request builder created from the UserRequestBuilder
        """
    ...
    def assign_license(self, add_licenses, remove_licenses):
        ...
        Args:
            add_licenses (:class:`AssignedLicense<microsoft.msgraph.model.assigned_license.AssignedLicense>`):
                The add_licenses to use in the method request
            remove_licenses (UUID):
                The remove_licenses to use in the method request          

        Returns:
            :class:`UserAssignLicenseRequestBuilder<microsoft.msgraph.request.user_assign_license.UserAssignLicenseRequestBuilder>`:
    ...
    def change_password(self, current_password=None, new_password=None):
        ...
        Returns:
            :class:`UserChangePasswordRequestBuilder<microsoft.msgraph.request.user_change_password.UserChangePasswordRequestBuilder>`:
    ...
    def send_mail(self, message, save_to_sent_items=None):
        ...
        Returns:
            :class:`UserSendMailRequestBuilder<microsoft.msgraph.request.user_send_mail.UserSendMailRequestBuilder>`:
    ...
    def reminder_view(self, start_date_time, end_date_time=None):
        ...
        Returns:
            :class:`UserReminderViewRequestBuilder<microsoft.msgraph.request.user_reminder_view.UserReminderViewRequestBuilder>`:
