...
class RejectedSendersCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`RejectedSendersCollectionPage<microsoft.msgraph.request.rejected_senders_collection.RejectedSendersCollectionPage>`:
...
class RejectedSendersCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self, expand=None, select=None, top=None, order_by=None, options=None):
        ...
        Returns:
            :class:`RejectedSendersCollectionRequest<microsoft.msgraph.request.rejected_senders_collection.RejectedSendersCollectionRequest>`:
