...
class MailFoldersCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`MailFoldersCollectionPage<microsoft.msgraph.request.mail_folders_collection.MailFoldersCollectionPage>`:
...
class MailFoldersCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self, expand=None, select=None, top=None, order_by=None, options=None):
        ...
        Returns:
            :class:`MailFoldersCollectionRequest<microsoft.msgraph.request.mail_folders_collection.MailFoldersCollectionRequest>`:
