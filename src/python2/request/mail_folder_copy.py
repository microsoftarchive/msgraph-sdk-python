...
class MailFolderCopyRequest(RequestBase):

    def __init__(self, request_url, client, options, destination_id=None):
        super(MailFolderCopyRequest, self).__init__(request_url, client, options)
        self.method = "POST"
        self.body_options={}
...
class MailFolderCopyRequestBuilder(RequestBuilderBase):

    def __init__(self, request_url, client, destination_id=None):
        super(MailFolderCopyRequestBuilder, self).__init__(request_url, client)
        self._method_options = {}

        self._method_options["DestinationId"] = destination_id

    def request(self, options=None):
        """Builds the request for the MailFolderCopy
        ...
        Returns: 
            :class:`MailFolderCopyRequest<microsoft.msgraph.request.mail_folder_copy.MailFolderCopyRequest>`:
                The request
        """
        req = MailFolderCopyRequest(self._request_url, self._client, options, destination_id=self._method_options["DestinationId"])
        return req
