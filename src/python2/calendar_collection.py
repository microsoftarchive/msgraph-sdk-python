...
class CalendarCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`CalendarCollectionPage<microsoft.msgraph.request.calendar_collection.CalendarCollectionPage>`:
...
class CalendarCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self, expand=None, select=None, top=None, order_by=None, options=None):
        ...
        Returns:
            :class:`CalendarCollectionRequest<microsoft.msgraph.request.calendar_collection.CalendarCollectionRequest>`:
