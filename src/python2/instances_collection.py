...
class InstancesCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`InstancesCollectionPage<microsoft.msgraph.request.instances_collection.InstancesCollectionPage>`:
...
class InstancesCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self, expand=None, select=None, top=None, order_by=None, options=None):
        ...
        Returns:
            :class:`InstancesCollectionRequest<microsoft.msgraph.request.instances_collection.InstancesCollectionRequest>`:
