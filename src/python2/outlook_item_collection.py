...
from ..request import outlook_item_request_builder # import OutlookItemRequestBuilder
#from .outlook_item_request_builder import OutlookItemRequestBuilder
...
class OutlookItemCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`OutlookItemCollectionPage<microsoft.msgraph.request.outlook_item_collection.OutlookItemCollectionPage>`:
...
class OutlookItemCollectionRequestBuilder(RequestBuilderBase):
    ...
    def __getitem__(self, key):
        ...
        Returns: 
            :class:`OutlookItemRequestBuilder<microsoft.msgraph.request.outlook_item_request_builder.OutlookItemRequestBuilder>`:
    ...
    def request(self, expand=None, select=None, top=None, order_by=None, options=None):
        ...
        Returns:
            :class:`OutlookItemCollectionRequest<microsoft.msgraph.request.outlook_item_collection.OutlookItemCollectionRequest>`:
