...
class DirectoryRoleTemplatesCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`DirectoryRoleTemplatesCollectionPage<msgraph.request.directory_role_templates_collection.DirectoryRoleTemplatesCollectionPage>`:
    ...
    @asyncio.coroutine
    def get_async(self):
        """Gets the DirectoryRoleTemplatesCollectionPage in async
...
class DirectoryRoleTemplatesCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self,order_by=None, options=None):
        ...
        Returns:
            :class:`DirectoryRoleTemplatesCollectionRequest<msgraph.request.directory_role_templates_collection.DirectoryRoleTemplatesCollectionRequest>`:
