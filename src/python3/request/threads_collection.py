...
class ThreadsCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`ThreadsCollectionPage<msgraph.request.threads_collection.ThreadsCollectionPage>`:
    ...
    @asyncio.coroutine
    def get_async(self):
        """Gets the ThreadsCollectionPage in async
...
class ThreadsCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self,select=None, filter=None, top=None, skip=None, order_by=None, options=None):
        ...
        Returns:
            :class:`ThreadsCollectionRequest<msgraph.request.threads_collection.ThreadsCollectionRequest>`:
