...
class ChildrenCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`ChildrenCollectionPage<msgraph.request.children_collection.ChildrenCollectionPage>`:
...
class ChildrenCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self,select=None, filter=None, top=None, skip=None, order_by=None, options=None):
        ...
        Returns:
            :class:`ChildrenCollectionRequest<msgraph.request.children_collection.ChildrenCollectionRequest>`:
