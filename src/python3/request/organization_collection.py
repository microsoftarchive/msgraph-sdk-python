...
from ..request import organization_request_builder 
...
class OrganizationCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`OrganizationCollectionPage<msgraph.request.organization_collection.OrganizationCollectionPage>`:
    ...
    @asyncio.coroutine
    def get_async(self):
        """Gets the OrganizationCollectionPage in async
...
class OrganizationCollectionRequestBuilder(RequestBuilderBase):
    ...
    def __getitem__(self, key):
        ...
        Returns: 
            :class:`OrganizationRequestBuilder<msgraph.request.organization_request_builder.OrganizationRequestBuilder>`:
    ...
    def request(self,top=None, order_by=None, options=None):
        ...
        Returns:
            :class:`OrganizationCollectionRequest<msgraph.request.organization_collection.OrganizationCollectionRequest>`:
