...
class PermissionsCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`PermissionsCollectionPage<msgraph.request.permissions_collection.PermissionsCollectionPage>`:
...
class PermissionsCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self,select=None, filter=None, top=None, skip=None, order_by=None, options=None):
        ...
        Returns:
            :class:`PermissionsCollectionRequest<msgraph.request.permissions_collection.PermissionsCollectionRequest>`:
