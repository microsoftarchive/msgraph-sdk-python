...
from ..request import thumbnail_set_request_builder 
...
class ThumbnailSetCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`ThumbnailSetCollectionPage<msgraph.request.thumbnail_set_collection.ThumbnailSetCollectionPage>`:
    ...
    @asyncio.coroutine
    def get_async(self):
        """Gets the ThumbnailSetCollectionPage in async
...
class ThumbnailSetCollectionRequestBuilder(RequestBuilderBase):
    ...
    def __getitem__(self, key):
        ...
        Returns: 
            :class:`ThumbnailSetRequestBuilder<msgraph.request.thumbnail_set_request_builder.ThumbnailSetRequestBuilder>`:
    ...
    def request(self,select=None, filter=None, top=None, skip=None, order_by=None, options=None):
        ...
        Returns:
            :class:`ThumbnailSetCollectionRequest<msgraph.request.thumbnail_set_collection.ThumbnailSetCollectionRequest>`:
