...
class DriveCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`DriveCollectionPage<msgraph.request.drive_collection.DriveCollectionPage>`:
    ...
    @asyncio.coroutine
    def get_async(self):
        """Gets the DriveCollectionPage in async
...
class DriveCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self,select=None, filter=None, top=None, skip=None, order_by=None, options=None):
        ...
        Returns:
            :class:`DriveCollectionRequest<msgraph.request.drive_collection.DriveCollectionRequest>`:
