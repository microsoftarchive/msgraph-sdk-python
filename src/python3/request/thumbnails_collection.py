...
class ThumbnailsCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`ThumbnailsCollectionPage<msgraph.request.thumbnails_collection.ThumbnailsCollectionPage>`:
...
class ThumbnailsCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self,select=None, filter=None, top=None, skip=None, order_by=None, options=None):
        ...
        Returns:
            :class:`ThumbnailsCollectionRequest<msgraph.request.thumbnails_collection.ThumbnailsCollectionRequest>`:
