...
class UsersCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`UsersCollectionPage<msgraph.request.users_collection.UsersCollectionPage>`:
    ...
    @asyncio.coroutine
    def get_async(self):
        """Gets the UsersCollectionPage in async
...
class UsersCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self,top=None, order_by=None, options=None):
        ...
        Returns:
            :class:`UsersCollectionRequest<msgraph.request.users_collection.UsersCollectionRequest>`:
