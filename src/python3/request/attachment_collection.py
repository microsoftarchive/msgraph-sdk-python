...
class AttachmentCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`AttachmentCollectionPage<msgraph.request.attachment_collection.AttachmentCollectionPage>`:
    ...
    @asyncio.coroutine
    def get_async(self):
        """Gets the AttachmentCollectionPage in async
...
class AttachmentCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self,select=None, filter=None, top=None, skip=None, order_by=None, options=None):
        ...
        Returns:
            :class:`AttachmentCollectionRequest<msgraph.request.attachment_collection.AttachmentCollectionRequest>`:
