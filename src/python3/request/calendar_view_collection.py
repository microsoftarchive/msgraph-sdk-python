...
class CalendarViewCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`CalendarViewCollectionPage<msgraph.request.calendar_view_collection.CalendarViewCollectionPage>`:
    ...
    @asyncio.coroutine
    def get_async(self):
        """Gets the CalendarViewCollectionPage in async
...
class CalendarViewCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self,select=None, filter=None, top=None, skip=None, order_by=None, options=None):
        ...
        Returns:
            :class:`CalendarViewCollectionRequest<msgraph.request.calendar_view_collection.CalendarViewCollectionRequest>`:
