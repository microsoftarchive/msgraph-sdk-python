...
from ..request import conversation_request_builder 
...
class ConversationsCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`ConversationsCollectionPage<msgraph.request.conversations_collection.ConversationsCollectionPage>`:
    ...
    @asyncio.coroutine
    def get_async(self):
        """Gets the ConversationsCollectionPage in async
...
class ConversationsCollectionRequestBuilder(RequestBuilderBase):
    ...
    def __getitem__(self, key):
        ...
        Returns: 
            :class:`ConversationRequestBuilder<msgraph.request.conversation_request_builder.ConversationRequestBuilder>`:
    ...
    def request(self,select=None, filter=None, top=None, skip=None, order_by=None, options=None):
        ...
        Returns:
            :class:`ConversationsCollectionRequest<msgraph.request.conversations_collection.ConversationsCollectionRequest>`:
