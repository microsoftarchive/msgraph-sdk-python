...
class CalendarsCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`CalendarsCollectionPage<msgraph.request.calendars_collection.CalendarsCollectionPage>`:
    ...
    @asyncio.coroutine
    def get_async(self):
        """Gets the CalendarsCollectionPage in async
...
class CalendarsCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self,select=None, filter=None, top=None, skip=None, order_by=None, options=None):
        ...
        Returns:
            :class:`CalendarsCollectionRequest<msgraph.request.calendars_collection.CalendarsCollectionRequest>`:
