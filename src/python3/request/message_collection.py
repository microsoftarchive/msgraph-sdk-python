...
class MessageCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`MessageCollectionPage<msgraph.request.message_collection.MessageCollectionPage>`:
    ...
    @asyncio.coroutine
    def get_async(self):
        """Gets the MessageCollectionPage in async
...
class MessageCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self,select=None, filter=None, top=None, skip=None, order_by=None, options=None):
        ...
        Returns:
            :class:`MessageCollectionRequest<msgraph.request.message_collection.MessageCollectionRequest>`:
