...
from ..request import file_attachment_request_builder 
...
class FileAttachmentCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`FileAttachmentCollectionPage<msgraph.request.file_attachment_collection.FileAttachmentCollectionPage>`:
    ...
    @asyncio.coroutine
    def get_async(self):
        """Gets the FileAttachmentCollectionPage in async
...
class FileAttachmentCollectionRequestBuilder(RequestBuilderBase):
    ...
    def __getitem__(self, key):
        ...
        Returns: 
            :class:`FileAttachmentRequestBuilder<msgraph.request.file_attachment_request_builder.FileAttachmentRequestBuilder>`:
    ...
    def request(self,select=None, filter=None, top=None, skip=None, order_by=None, options=None):
        ...
        Returns:
            :class:`FileAttachmentCollectionRequest<msgraph.request.file_attachment_collection.FileAttachmentCollectionRequest>`:
