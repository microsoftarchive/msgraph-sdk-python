...
class PostsCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`PostsCollectionPage<msgraph.request.posts_collection.PostsCollectionPage>`:
    ...
    @asyncio.coroutine
    def get_async(self):
        """Gets the PostsCollectionPage in async
...
class PostsCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self,select=None, filter=None, top=None, skip=None, order_by=None, options=None):
        ...
        Returns:
            :class:`PostsCollectionRequest<msgraph.request.posts_collection.PostsCollectionRequest>`:
