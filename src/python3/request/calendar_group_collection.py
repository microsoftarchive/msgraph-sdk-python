...
class CalendarGroupCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`CalendarGroupCollectionPage<msgraph.request.calendar_group_collection.CalendarGroupCollectionPage>`:
    ...
    @asyncio.coroutine
    def get_async(self):
        """Gets the CalendarGroupCollectionPage in async
...
class CalendarGroupCollectionRequestBuilder(RequestBuilderBase):
    ...
    def request(self,select=None, filter=None, top=None, skip=None, order_by=None, options=None):
        ...
        Returns:
            :class:`CalendarGroupCollectionRequest<msgraph.request.calendar_group_collection.CalendarGroupCollectionRequest>`:
