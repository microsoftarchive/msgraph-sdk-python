...
class DirectoryObjectGetMemberObjectsRequest(CollectionRequestBase):

    def __init__(self, request_url, client, options, security_enabled_only=None):
        super(DirectoryObjectGetMemberObjectsRequest, self).__init__(request_url, client, options)
        self.method = "POST"
        self.body_options={}
...
class DirectoryObjectGetMemberObjectsRequestBuilder(RequestBuilderBase):

    def __init__(self, request_url, client, security_enabled_only=None):
        super(DirectoryObjectGetMemberObjectsRequestBuilder, self).__init__(request_url, client)
    ...
    def request(self,select=None, filter=None, top=None, skip=None, order_by=None, options=None):
        """Builds the request for the DirectoryObjectGetMemberObjects
        ...
        Returns: 
            :class:`DirectoryObjectGetMemberObjectsRequest<msgraph.request.directory_object_get_member_objects.DirectoryObjectGetMemberObjectsRequest>`:
                The request
        """
        req = DirectoryObjectGetMemberObjectsRequest(self._request_url, self._client, options, security_enabled_only=self._method_options["securityEnabledOnly"])
