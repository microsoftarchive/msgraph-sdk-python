...
class SubscriptionRequestBuilder(RequestBuilderBase):
    ...
    def request(self, options=None):
        ...
        Returns:
            :class:`SubscriptionRequest<msgraph.request.subscription_request.SubscriptionRequest>`:
    ...
    def update(self, subscription):
        ...
        Args:
            subscription (:class:`Subscription<msgraph.model.subscription.Subscription>`):
