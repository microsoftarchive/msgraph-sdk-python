...
from ..request import subscribed_sku_request_builder 
...
class SubscribedSkusCollectionRequest(CollectionRequestBase):
    ...
    def get(self):
        ...
        Returns: 
            :class:`SubscribedSkusCollectionPage<msgraph.request.subscribed_skus_collection.SubscribedSkusCollectionPage>`:
    ...
    @asyncio.coroutine
    def get_async(self):
        """Gets the SubscribedSkusCollectionPage in async
...
class SubscribedSkusCollectionRequestBuilder(RequestBuilderBase):
    ...
    def __getitem__(self, key):
        ...
        Returns: 
            :class:`SubscribedSkuRequestBuilder<msgraph.request.subscribed_sku_request_builder.SubscribedSkuRequestBuilder>`:
    ...
    def request(self,order_by=None, options=None):
        ...
        Returns:
            :class:`SubscribedSkusCollectionRequest<msgraph.request.subscribed_skus_collection.SubscribedSkusCollectionRequest>`:
